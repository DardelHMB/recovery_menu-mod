...
static void option_SetColdbootTitle(void)
{
    static const Menu coldbootTitleOptions[] = {
        ...
        {"Wii U Menu (EUR)", {.tid = 0x0005001010040200}},
            {"Health and Safety Infomation (JPN)", {.tid = 0x000500101004E000}},
            {"Health and Safety Infomation (USA)", {.tid = 0x000500101004E100}},
            {"Health and Safety Infomation (EUR)", {.tid = 0x000500101004E200}},
